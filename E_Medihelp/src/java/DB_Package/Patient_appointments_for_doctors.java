 ...
 * @author NIMESH_PC
 */
@WebServlet(name = "Patient_appointments_for_doctors", urlPatterns = {"/Patient_appointments_for_doctors"})
public class Patient_appointments_for_doctors extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int uid = Integer.parseInt(request.getParameter("doctor_appointment"));
